// Content source: existing homepage and the five supplied references (2026-09-17).
export const servicesData = [
  {
    ...
    image: '/images/home/service-web.webp'
  },
  {
    id: 1,
    ...
    fullDesc: 'Chuẩn hóa thông tin doanh nghiệp, tối ưu hồ sơ Google Maps và hướng dẫn thu thập đánh giá từ khách hàng thực tế. Phạm vi công việc được thống nhất theo hiện trạng của bạn.',
    image: '/images/home/service-maps.webp'
  },
  {
    id: 2,
    title: 'Google Ads',
    ...
    image: '/images/home/service-ads.webp'
  },
  {
    id: 3,
    ...
    image: '/images/home/service-content.webp'
  },
  {
    id: 4,
    title: 'CRM & Automation',
    shortDesc: 'Quản lý khách hàng hiệu quả, tự động hóa quy trình, tiết kiệm thời gian và tăng doanh thu.',
    fullDesc: 'Kết nối các kênh nhận thông tin khách hàng, sắp xếp trạng thái chăm sóc và tự động hóa các tác vụ lặp lại phù hợp với quy trình của doanh nghiệp.',
    image: '/images/home/service-crm.webp'
  }
];
...
export const storiesData = [
  {
    ...
    image: '/images/home/story-cafe.webp'
  },
  {
    ...
    image: '/images/home/story-stay.webp'
  },
  {
    ...
    image: '/images/home/story-repair.webp'
  },
  {
    icon: 'bag' as const,
    category: 'BÁN LẺ & SME',
    ...
    image: '/images/home/story-shop.webp'
  }
];
